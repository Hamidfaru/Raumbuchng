    ...
    <div className="min-h-screen bg-background">
      <div className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 container mx-auto px-4 pb-8">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Workshop-Raum</h1>
          <div className="flex items-center gap-4 text-lg">
            <div className="flex items-center gap-2">
              <Users className="h-5 w-5" />
              <span>Bis zu 20 Personen</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="text-lg text-muted-foreground mb-6">
                  Unser Workshop-Raum ist der ideale Ort für Workshops, Brainstorming-Sessions 
                  und Team-Events mit flexibler Bestuhlung. Der großzügige Raum bietet Platz 
                  für bis zu 20 Personen und fördert Kreativität und Zusammenarbeit.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Beamer & Whiteboards</p>
                      <p className="text-sm text-muted-foreground">Mehrere interaktive Whiteboards</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Flexible Raumgestaltung</p>
                      <p className="text-sm text-muted-foreground">Modulare Tische und Stühle</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-4">
              ...
              <CardContent>
                <AvailabilityChecker roomName="Workshop-Raum" />
              </CardContent>
            </Card>
          </div>
        </div>
